      ...
      <div id="card-content">
        <div id="card-title">
          ...
          <div class="registrasi">
            <p>Belum jadi member? Registrasi <button class="btn btn-primary" type="submit" name="submit"><a style="text-decoration: none; color: white;" href="registrasi.php">Disini</a></button></p>
          </div>
        </div>
      </div>
    </div>
